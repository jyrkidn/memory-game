...
use App\Filament\Resources\CardCategoryResource\RelationManagers;
...
class CardCategoryResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('cards_count')->counts('cards')
            ])
            ->filters([
                //
            ])
    ...
    {
        return [
            RelationManagers\CardsRelationManager::make(),
        ];
    }
